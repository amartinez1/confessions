"""
Django settings for confesionsapp project.
...
SECRET_KEY = '+w()8-c*_qz80u8@nr7@s*0fu$8tubv=#o_yoaagz6wnnzkw9t'
...
ROOT_URLCONF = 'confesionsapp.urls'

WSGI_APPLICATION = 'confesionsapp.wsgi.application'
